...
import static com.mycompany.omega.classes.Employee.Role.ADMINISTRATOR;
import static com.mycompany.omega.classes.Employee.Role.PURCHASE_MANAGER;
...
public class Admin extends Employee{
    ...
    public void registerUser(String id, String name, String roleStr, String email, String password) {
        ...
        try {
            ...
            writer.write(user.getEmployeeID() + "," + user.getName() + "," + user.getRole() + "," + user.getEmail() + "," + user.getPassword() + "\n");
            writer.close();
